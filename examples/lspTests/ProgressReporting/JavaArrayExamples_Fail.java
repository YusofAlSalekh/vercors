...
class Test {
    ...
    /*@
      context_everywhere a != null && a.length == 10;
      context (\forall* int i; 0 <= i && i < 5; Perm(a[i], 1));
      context (\forall* int i; 0 <= i && i < 10; Perm(a[i % 5], read));
    @*/
    void triggerInjectivity(int[] a) {}
}
